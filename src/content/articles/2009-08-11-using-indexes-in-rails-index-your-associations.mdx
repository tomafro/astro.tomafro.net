...
To try and improve this I've planned a series of posts on indexes, targetted at rails developers.  In this first post I'll [introduce indexes and how to index your associations]({{ url }}), then I'll write about choosing additional indexes to improve query performance, and finally how to avoid redundant and duplicate indexes.
